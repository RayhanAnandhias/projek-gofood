...
public class LocationUtils {
    ...
    public LocationUtils(MongoDbUtils mongoUtils, MongoCollection<Location> locations) {
    ...
    public List<Location> findShortestRoute(Location source, Location dest) {
        ...
        try {
            Set<Location> location  = mongoUtils.getAllLocData();
            ...
            System.out.println(route.stream().map(Location::getStreet).collect(Collectors.toList()));
            return route;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
    ...
    public boolean insertLocData() {
        try {
            ...
            loc.add(new Location("11", "Baker Street", 51.5226, -0.1571));
            loc.add(new Location("12", "Balham", 51.4431, -0.1525));
            loc.add(new Location("13", "Bank", 51.5133, -0.0886));
            loc.add(new Location("14", "Barbican", 51.5204, -0.0979));
            loc.add(new Location("15", "Barking", 51.5396, 0.081));
            loc.add(new Location("16", "Barkingside", 51.5856, 0.0887));
            loc.add(new Location("17", "Barons Court", 51.4905, -0.2139));
            loc.add(new Location("18", "Bayswater", 51.5121, -0.1879));
            loc.add(new Location("19", "Beckton", 51.5148, 0.0613));
            loc.add(new Location("20", "Beckton Park", 51.5087, 0.055));
            loc.add(new Location("21", "Becontree", 51.5403, 0.127));
            loc.add(new Location("22", "Belsize Park", 51.5504, -0.1642));
            loc.add(new Location("23", "Bermondsey", 51.4979, -0.0637));
            loc.add(new Location("24", "Bethnal Green", 51.527, -0.0549));
            loc.add(new Location("25", "Blackfriars", 51.512, -0.1031));
            loc.add(new Location("26", "Blackhorse Road", 51.5867, -0.0417));
            loc.add(new Location("27", "Blackwall", 51.5079, -0.0066));
            loc.add(new Location("28", "Bond Street", 51.5142, -0.1494));
            loc.add(new Location("29", "Borough", 51.5011, -0.0943));
            loc.add(new Location("30", "Boston Manor", 51.4956, -0.325));
            loc.add(new Location("31", "Bounds Green", 51.6071, -0.1243));
            loc.add(new Location("32", "Bow Church", 51.5273, -0.0208));
            loc.add(new Location("33", "Bow Road", 51.5269, -0.0247));
            loc.add(new Location("34", "Brent Cross", 51.5766, -0.2136));
            loc.add(new Location("35", "Brixton", 51.4627, -0.1145));
            loc.add(new Location("36", "Bromley-By-Bow", 51.5248, -0.0119));
            loc.add(new Location("37", "Buckhurst Hill", 51.6266, 0.0471));
            loc.add(new Location("38", "Burnt Oak", 51.6028, -0.2641));
            loc.add(new Location("39", "Caledonian Road", 51.5481, -0.1188));
            loc.add(new Location("40", "Camden Town", 51.5392, -0.1426));
            loc.add(new Location("41", "Canada Water", 51.4982, -0.0502));
            loc.add(new Location("42", "Canary Wharf", 51.5051, -0.0209));
            loc.add(new Location("43", "Canning Town", 51.5147, 0.0082));
            loc.add(new Location("44", "Cannon Street", 51.5113, -0.0904));
            loc.add(new Location("45", "Canons Park", 51.6078, -0.2947));
            loc.add(new Location("46", "Chalfont & Latimer", 51.6679, -0.561));
            loc.add(new Location("47", "Chalk Farm", 51.5441, -0.1538));
            loc.add(new Location("48", "Chancery Lane", 51.5185, -0.1111));
            loc.add(new Location("49", "Charing Cross", 51.508, -0.1247));
            loc.add(new Location("50", "Chesham", 51.7052, -0.611));
            loc.add(new Location("51", "Chigwell", 51.6177, 0.0755));
            loc.add(new Location("52", "Chiswick Park", 51.4946, -0.2678));
            loc.add(new Location("53", "Chorleywood", 51.6543, -0.5183));
            loc.add(new Location("54", "Clapham Common", 51.4618, -0.1384));
            loc.add(new Location("55", "Clapham North", 51.4649, -0.1299));
            loc.add(new Location("56", "Clapham South", 51.4527, -0.148));
            loc.add(new Location("57", "Cockfosters", 51.6517, -0.1496));
            loc.add(new Location("58", "Colindale", 51.5955, -0.2502));
            loc.add(new Location("59", "Colliers Wood", 51.418, -0.1778));
            loc.add(new Location("60", "Covent Garden", 51.5129, -0.1243));
            loc.add(new Location("61", "Crossharbour & London Arena", 51.4957, -0.0144));
            loc.add(new Location("62", "Croxley", 51.647, -0.4412));
            loc.add(new Location("63", "Custom House", 51.5095, 0.0276));
            loc.add(new Location("64", "Cutty Sark", 51.4827, -0.0096));
            loc.add(new Location("65", "Cyprus", 51.5085, 0.064));
            loc.add(new Location("66", "Dagenham East", 51.5443, 0.1655));
            loc.add(new Location("67", "Dagenham Heathway", 51.5417, 0.1469));
            loc.add(new Location("68", "Debden", 51.6455, 0.0838));
            loc.add(new Location("69", "Deptford Bridge", 51.474, -0.0216));
            loc.add(new Location("70", "Devons Road", 51.5223, -0.0173));
            loc.add(new Location("71", "Dollis Hill", 51.552, -0.2387));
            loc.add(new Location("72", "Ealing Broadway", 51.5152, -0.3017));
            loc.add(new Location("73", "Ealing Common", 51.5101, -0.2882));
            loc.add(new Location("74", "Earl's Court", 51.492, -0.1973));
            loc.add(new Location("75", "Eastcote", 51.5765, -0.397));
            loc.add(new Location("76", "East Acton", 51.5168, -0.2474));
            loc.add(new Location("77", "East Finchley", 51.5874, -0.165));
            loc.add(new Location("78", "East Ham", 51.5394, 0.0518));
            loc.add(new Location("79", "East India", 51.5093, -0.0021));
            loc.add(new Location("80", "East Putney", 51.4586, -0.2112));
            loc.add(new Location("81", "Edgware", 51.6137, -0.275));
            loc.add(new Location("82", "Edgware Road (B)", 51.5199, -0.1679));
            loc.add(new Location("83", "Edgware Road (C)", 51.5203, -0.17));
            loc.add(new Location("84", "Elephant & Castle", 51.4943, -0.1001));
            loc.add(new Location("85", "Elm Park", 51.5496, 0.1977));
            loc.add(new Location("86", "Elverson Road", 51.4693, -0.0174));
            loc.add(new Location("87", "Embankment", 51.5074, -0.1223));
            loc.add(new Location("88", "Epping", 51.6937, 0.1139));
            loc.add(new Location("89", "Euston", 51.5282, -0.1337));
            loc.add(new Location("90", "Euston Square", 51.526, -0.1359));
            loc.add(new Location("91", "Fairlop", 51.596, 0.0912));
            loc.add(new Location("92", "Farringdon", 51.5203, -0.1053));
            loc.add(new Location("93", "Finchley Central", 51.6012, -0.1932));
            loc.add(new Location("94", "Finchley Road", 51.5472, -0.1803));
            loc.add(new Location("95", "Finsbury Park", 51.5642, -0.1065));
            loc.add(new Location("96", "Fulham Broadway", 51.4804, -0.195));
            loc.add(new Location("97", "Gallions Reach", 51.5096, 0.0716));
            loc.add(new Location("98", "Gants Hill", 51.5765, 0.0663));
            loc.add(new Location("99", "Gloucester Road", 51.4945, -0.1829));
            loc.add(new Location("100", "Golders Green", 51.5724, -0.1941));
            loc.add(new Location("101", "Goldhawk Road", 51.5018, -0.2267));
            loc.add(new Location("102", "Goodge Street", 51.5205, -0.1347));
            loc.add(new Location("103", "Grange Hill", 51.6132, 0.0923));
            loc.add(new Location("104", "Great Portland Street", 51.5238, -0.1439));
            loc.add(new Location("105", "Greenford", 51.5423, -0.3456));
            loc.add(new Location("106", "Greenwich", 51.4781, -0.0149));
            loc.add(new Location("107", "Green Park", 51.5067, -0.1428));
            loc.add(new Location("108", "Gunnersbury", 51.4915, -0.2754));
            loc.add(new Location("109", "Hainault", 51.603, 0.0933));
            loc.add(new Location("110", "Hammersmith", 51.4936, -0.2251));
            loc.add(new Location("111", "Hampstead", 51.5568, -0.178));
            loc.add(new Location("112", "Hanger Lane", 51.5302, -0.2933));
            loc.add(new Location("113", "Harlesden", 51.5362, -0.2575));
            loc.add(new Location("114", "Harrow & Wealdston", 51.5925, -0.3351));
            loc.add(new Location("115", "Harrow-on-the-Hill", 51.5793, -0.3366));
            loc.add(new Location("116", "Hatton Cross", 51.4669, -0.4227));
            loc.add(new Location("117", "Heathrow Terminals 1, 2 & 3", 51.4713, -0.4524));
            loc.add(new Location("118", "Heathrow Terminal 4", 51.4598, -0.4476));
            loc.add(new Location("119", "Hendon Central", 51.5829, -0.2259));
            loc.add(new Location("120", "Heron Quays", 51.5033, -0.0215));
            loc.add(new Location("121", "High Barnet", 51.6503, -0.1943));
            loc.add(new Location("122", "High Street Kensington", 51.5009, -0.1925));
            loc.add(new Location("123", "Highbury & Islington", 51.546, -0.104));
            loc.add(new Location("124", "Highgate", 51.5777, -0.1458));
            loc.add(new Location("125", "Hillingdon", 51.5538, -0.4499));
            loc.add(new Location("126", "Holborn", 51.5174, -0.12));
            loc.add(new Location("127", "Holland Park", 51.5075, -0.206));
            loc.add(new Location("128", "Holloway Road", 51.5526, -0.1132));
            loc.add(new Location("129", "Hornchurch", 51.5539, 0.2184));
            loc.add(new Location("130", "Hounslow Central", 51.4713, -0.3665));
            loc.add(new Location("131", "Hounslow East", 51.4733, -0.3564));
            loc.add(new Location("132", "Hounslow West", 51.4734, -0.3855));
            loc.add(new Location("133", "Hyde Park Corner", 51.5027, -0.1527));
            loc.add(new Location("134", "Ickenham", 51.5619, -0.4421));
            loc.add(new Location("135", "Island Gardens", 51.4871, -0.0101));
            loc.add(new Location("136", "Kennington", 51.4884, -0.1053));
            loc.add(new Location("137", "Kensal Green", 51.5304, -0.225));
            loc.add(new Location("138", "Kensington (Olympia)", 51.4983, -0.2106));
            loc.add(new Location("139", "Kentish Town", 51.5507, -0.1402));
            loc.add(new Location("140", "Kenton", 51.5816, -0.3162));
            loc.add(new Location("141", "Kew Gardens", 51.477, -0.285));
            loc.add(new Location("142", "Kilburn", 51.5471, -0.2047));
            loc.add(new Location("143", "Kilburn Park", 51.5351, -0.1939));
            loc.add(new Location("144", "Kingsbury", 51.5846, -0.2786));
            loc.add(new Location("145", "King's Cross St. Pancras", 51.5308, -0.1238));
            loc.add(new Location("146", "Knightsbridge", 51.5015, -0.1607));
            loc.add(new Location("147", "Ladbroke Grove", 51.5172, -0.2107));
            loc.add(new Location("148", "Lambeth North", 51.4991, -0.1115));
            loc.add(new Location("149", "Lancaster Gate", 51.5119, -0.1756));
            loc.add(new Location("150", "Latimer Road", 51.5139, -0.2172));
            loc.add(new Location("151", "Leicester Square", 51.5113, -0.1281));
            loc.add(new Location("152", "Lewisham", 51.4657, -0.0142));
            loc.add(new Location("153", "Leyton", 51.5566, -0.0053));
            loc.add(new Location("154", "Leytonstone", 51.5683, 0.0083));
            loc.add(new Location("155", "Limehouse", 51.5123, -0.0396));
            loc.add(new Location("156", "Liverpool Street", 51.5178, -0.0823));
            loc.add(new Location("157", "London Bridge", 51.5052, -0.0864));
            loc.add(new Location("158", "Loughton", 51.6412, 0.0558));
            loc.add(new Location("159", "Maida Vale", 51.53, -0.1854));
            loc.add(new Location("160", "Manor House", 51.5712, -0.0958));
            loc.add(new Location("161", "Mansion House", 51.5122, -0.094));
            loc.add(new Location("162", "Marble Arch", 51.5136, -0.1586));
            loc.add(new Location("163", "Marylebone", 51.5225, -0.1631));
            loc.add(new Location("164", "Mile End", 51.5249, -0.0332));
            loc.add(new Location("165", "Mill Hill East", 51.6082, -0.2103));
            loc.add(new Location("166", "Monument", 51.5108, -0.0863));
            loc.add(new Location("167", "Moorgate", 51.5186, -0.0886));
            loc.add(new Location("168", "Moor Park", 51.6294, -0.432));
            loc.add(new Location("169", "Morden", 51.4022, -0.1948));
            loc.add(new Location("170", "Mornington Crescent", 51.5342, -0.1387));
            loc.add(new Location("171", "Mudchute", 51.4902, -0.0145));
            loc.add(new Location("172", "Neasden", 51.5542, -0.2503));
            loc.add(new Location("173", "Newbury Park", 51.5756, 0.0899));
            loc.add(new Location("174", "New Cross", 51.4767, -0.0327));
            loc.add(new Location("175", "New Cross Gate", 51.4757, -0.0402));
            loc.add(new Location("176", "Northfields", 51.4995, -0.3142));
            loc.add(new Location("177", "Northolt", 51.5483, -0.3687));
            loc.add(new Location("178", "Northwick Park", 51.5784, -0.3184));
            loc.add(new Location("179", "Northwood", 51.6111, -0.424));
            loc.add(new Location("180", "Northwood Hills", 51.6004, -0.4092));
            loc.add(new Location("181", "North Acton", 51.5237, -0.2597));
            loc.add(new Location("182", "North Ealing", 51.5175, -0.2887));
            loc.add(new Location("183", "North Greenwich", 51.5005, 0.0039));
            loc.add(new Location("184", "North Harrow", 51.5846, -0.3626));
            loc.add(new Location("185", "North Wembley", 51.5621, -0.3034));
            loc.add(new Location("186", "Notting Hill Gate", 51.5094, -0.1967));
            loc.add(new Location("187", "Oakwood", 51.6476, -0.1318));
            loc.add(new Location("188", "Old Street", 51.5263, -0.0873));
            loc.add(new Location("189", "Osterley", 51.4813, -0.3522));
            loc.add(new Location("190", "Oval", 51.4819, -0.113));
            loc.add(new Location("191", "Oxford Circus", 51.515, -0.1415));
            loc.add(new Location("192", "Paddington", 51.5154, -0.1755));
            loc.add(new Location("193", "Park Royal", 51.527, -0.2841));
            loc.add(new Location("194", "Parsons Green", 51.4753, -0.2011));
            loc.add(new Location("195", "Perivale", 51.5366, -0.3232));
            loc.add(new Location("196", "Picadilly Circus", 51.5098, -0.1342));
            loc.add(new Location("197", "Pimlico", 51.4893, -0.1334));
            loc.add(new Location("198", "Pinner", 51.5926, -0.3805));
            loc.add(new Location("199", "Plaistow", 51.5313, 0.0172));
            loc.add(new Location("200", "Poplar", 51.5077, -0.0173));
            loc.add(new Location("201", "Preston Road", 51.572, -0.2954));
            loc.add(new Location("202", "Prince Regent", 51.5093, 0.0336));
            loc.add(new Location("203", "Pudding Mill Lane", 51.5343, -0.0139));
            loc.add(new Location("204", "Putney Bridge", 51.4682, -0.2089));
            loc.add(new Location("205", "Queen's Park", 51.5341, -0.2047));
            loc.add(new Location("206", "Queensbury", 51.5942, -0.2861));
            loc.add(new Location("207", "Queensway", 51.5107, -0.1877));
            loc.add(new Location("208", "Ravenscourt Park", 51.4942, -0.2359));
            loc.add(new Location("209", "Rayners Lane", 51.5753, -0.3714));
            loc.add(new Location("210", "Redbridge", 51.5763, 0.0454));
            loc.add(new Location("211", "Regent's Park", 51.5234, -0.1466));
            loc.add(new Location("212", "Richmond", 51.4633, -0.3013));
            loc.add(new Location("213", "Rickmansworth", 51.6404, -0.4733));
            loc.add(new Location("214", "Roding Valley", 51.6171, 0.0439));
            loc.add(new Location("215", "Rotherhithe", 51.501, -0.0525));
            loc.add(new Location("216", "Royal Albert", 51.5084, 0.0465));
            loc.add(new Location("217", "Royal Oak", 51.519, -0.188));
            loc.add(new Location("218", "Royal Victoria", 51.5091, 0.0181));
            loc.add(new Location("219", "Ruislip", 51.5715, -0.4213));
            loc.add(new Location("220", "Ruislip Gardens", 51.5606, -0.4103));
            loc.add(new Location("221", "Ruislip Manor", 51.5732, -0.4125));
            loc.add(new Location("222", "Russell Square", 51.523, -0.1244));
            loc.add(new Location("223", "Seven Sisters", 51.5822, -0.0749));
            loc.add(new Location("224", "Shadwell", 51.5117, -0.056));
            loc.add(new Location("225", "Shepherd's Bush (C)", 51.5046, -0.2187));
            loc.add(new Location("226", "Shepherd's Bush (H)", 51.5058, -0.2265));
            loc.add(new Location("227", "Shoreditch", 51.5227, -0.0708));
            loc.add(new Location("228", "Sloane Square", 51.4924, -0.1565));
            loc.add(new Location("229", "Snaresbrook", 51.5808, 0.0216));
            loc.add(new Location("230", "Southfields", 51.4454, -0.2066));
            loc.add(new Location("231", "Southgate", 51.6322, -0.128));
            loc.add(new Location("232", "Southwark", 51.501, -0.1052));
            loc.add(new Location("233", "South Ealing", 51.5011, -0.3072));
            loc.add(new Location("234", "South Harrow", 51.5646, -0.3521));
            loc.add(new Location("235", "South Kensington", 51.4941, -0.1738));
            loc.add(new Location("236", "South Kenton", 51.5701, -0.3081));
            loc.add(new Location("237", "South Quay", 51.5007, -0.0191));
            loc.add(new Location("238", "South Ruislip", 51.5569, -0.3988));
            loc.add(new Location("239", "South Wimbledon", 51.4154, -0.1919));
            loc.add(new Location("240", "South Woodford", 51.5917, 0.0275));
            loc.add(new Location("241", "Stamford Brook", 51.495, -0.2459));
            loc.add(new Location("242", "Stanmore", 51.6194, -0.3028));
            loc.add(new Location("243", "Stepney Green", 51.5221, -0.047));
            loc.add(new Location("244", "Stockwell", 51.4723, -0.123));
            loc.add(new Location("245", "Stonebridge Park", 51.5439, -0.2759));
            loc.add(new Location("246", "Stratford", 51.5416, -0.0042));
            loc.add(new Location("247", "St. James's Park", 51.4994, -0.1335));
            loc.add(new Location("248", "St. John's Wood", 51.5347, -0.174));
            loc.add(new Location("249", "St. Paul's", 51.5146, -0.0973));
            loc.add(new Location("250", "Sudbury Hill", 51.5569, -0.3366));
            loc.add(new Location("251", "Sudbury Town", 51.5507, -0.3156));
            loc.add(new Location("252", "Surrey Quays", 51.4933, -0.0478));
            loc.add(new Location("253", "Swiss Cottage", 51.5432, -0.1738));
            loc.add(new Location("254", "Temple", 51.5111, -0.1141));
            loc.add(new Location("255", "Theydon Bois", 51.6717, 0.1033));
            loc.add(new Location("256", "Tooting Bec", 51.4361, -0.1598));
            loc.add(new Location("257", "Tooting Broadway", 51.4275, -0.168));
            loc.add(new Location("258", "Tottenham Court Road", 51.5165, -0.131));
            loc.add(new Location("259", "Tottenham Hale", 51.5882, -0.0594));
            loc.add(new Location("260", "Totteridge & Whetstone", 51.6302, -0.1791));
            loc.add(new Location("261", "Tower Gateway", 51.5106, -0.0743));
            loc.add(new Location("262", "Tower Hill", 51.5098, -0.0766));
            loc.add(new Location("263", "Tufnell Park", 51.5567, -0.1374));
            loc.add(new Location("264", "Turnham Green", 51.4951, -0.2547));
            loc.add(new Location("265", "Turnpike Lane", 51.5904, -0.1028));
            loc.add(new Location("266", "Upminster", 51.559, 0.251));
            loc.add(new Location("267", "Upminster Bridge", 51.5582, 0.2343));
            loc.add(new Location("268", "Upney", 51.5385, 0.1014));
            loc.add(new Location("269", "Upton Park", 51.5352, 0.0343));
            loc.add(new Location("270", "Uxbridge", 51.5463, -0.4786));
            loc.add(new Location("271", "Vauxhall", 51.4861, -0.1253));
            loc.add(new Location("272", "Victoria", 51.4965, -0.1447));
            loc.add(new Location("273", "Walthamstow Central", 51.583, -0.0195));
            loc.add(new Location("274", "Wanstead", 51.5775, 0.0288));
            loc.add(new Location("275", "Wapping", 51.5043, -0.0558));
            loc.add(new Location("276", "Warren Street", 51.5247, -0.1384));
            loc.add(new Location("277", "Warwick Avenue", 51.5235, -0.1835));
            loc.add(new Location("278", "Waterloo", 51.5036, -0.1143));
            loc.add(new Location("279", "Watford", 51.6573, -0.4177));
            loc.add(new Location("280", "Wembley Central", 51.5519, -0.2963));
            loc.add(new Location("281", "Wembley Park", 51.5635, -0.2795));
            loc.add(new Location("282", "Westbourne Park", 51.521, -0.2011));
            loc.add(new Location("283", "Westferry", 51.5097, -0.0265));
            loc.add(new Location("284", "Westminster", 51.501, -0.1254));
            loc.add(new Location("285", "West Acton", 51.518, -0.2809));
            loc.add(new Location("286", "West Brompton", 51.4872, -0.1953));
            loc.add(new Location("287", "West Finchley", 51.6095, -0.1883));
            loc.add(new Location("288", "West Ham", 51.5287, 0.0056));
            loc.add(new Location("289", "West Hampstead", 51.5469, -0.1906));
            loc.add(new Location("290", "West Harrow", 51.5795, -0.3533));
            loc.add(new Location("291", "West India Quay", 51.507, -0.0203));
            loc.add(new Location("292", "West Kensington", 51.4907, -0.2065));
            loc.add(new Location("293", "West Ruislip", 51.5696, -0.4376));
            loc.add(new Location("294", "Whitechapel", 51.5194, -0.0612));
            loc.add(new Location("295", "White City", 51.512, -0.2239));
            loc.add(new Location("296", "Willesden Green", 51.5492, -0.2215));
            loc.add(new Location("297", "Willesden Junction", 51.5326, -0.2478));
            loc.add(new Location("298", "Wimbledon", 51.4214, -0.2064));
            loc.add(new Location("299", "Wimbledon Park", 51.4343, -0.1992));
            loc.add(new Location("300", "Woodford", 51.607, 0.0341));
            loc.add(new Location("301", "Woodside Park", 51.6179, -0.1856));
            loc.add(new Location("302", "Wood Green", 51.5975, -0.1097));
            if(locations.find().spliterator().getExactSizeIfKnown() != loc.size()) {
                locations.deleteMany(new BasicDBObject());
                locations.insertMany(new ArrayList<Location>(loc));
            }
            return true;
        } catch (Exception e) {
            e.printStackTrace();
